<script>
    ...
    const isActive = (p) => {
        ...
        try {
            ...
            today.setHours(0, 0, 0, 0); // comparaison date-only

            const end = new Date(p.end_date);
            if (Number.isNaN(end.getTime())) return true; // fallback safe
                ...
                <table class="kittTable">
                    ...
                    <tr>
                        ...
                        <th class="clickable" on:click={() => toggleSort("start_date")}>
                            Start <span
                                class="arrow">{sortKey === "start_date" ? (sortDir === "asc" ? "▲" : "▼") : ""}</span>
                        </th>
                        <th class="clickable" on:click={() => toggleSort("end_date")}>
                            End <span
                                class="arrow">{sortKey === "end_date" ? (sortDir === "asc" ? "▲" : "▼") : ""}</span>
                        </th>
                        <th class="clickable" on:click={() => toggleSort("manager_name")}>
                            Manager <span
                                class="arrow">{sortKey === "manager_name" ? (sortDir === "asc" ? "▲" : "▼") : ""}</span>
                        </th>
                        <th>Status</th>
                    </tr>
                    </thead>
...
<style>
    ...
    .kittTable tbody tr.selected {
        ...
        box-shadow: inset 0 0 0 1px rgba(255, 0, 60, 0.35),
    ...
    .detailsHeader {
        ...
        background: linear-gradient(90deg, rgba(255, 0, 60, 0.08), transparent 65%),
        linear-gradient(180deg, rgba(255, 0, 60, 0.06), transparent 70%);
    }
    ...
    .btn:hover {
        ...
        border-color: rgba(255, 0, 60, 0.55);
        box-shadow: inset 0 0 14px rgba(255, 0, 60, 0.16),
